const modulos = [
  {
    ...
    aulas: [
      { id: 1, titulo: 'Boas-vindas ao programa', tipo: 'Introdução', videoUrl: 'https://www.youtube.com/embed/l4BbL176NEA', texto: 'Conheça a estrutura do programa e como tirar o máximo proveito das aulas.' },
      { id: 2, titulo: 'Alongamento inicial', tipo: 'Alongamento', videoUrl: 'https://www.youtube.com/embed/17k8IZC_YNI', texto: 'Rotina leve para preparar o corpo antes dos treinos mais intensos.' },
      { id: 3, titulo: 'Exercicios 1', tipo: 'Bem-estar', videoUrl: 'https://www.youtube.com/embed/slmWjDCdZRE', texto: 'Exercicio de flexao de bracos sem apoio.' },
      { id: 4, titulo: 'Exercicios 1 adaptado', tipo: 'Bem-estar', videoUrl: 'https://www.youtube.com/embed/QhS_RKCh03g', texto: 'Exercicio de flexao de bracos com apoio.' },
      { id: 5, titulo: 'Exercicios socos', tipo: 'Bem-estar', videoUrl: 'https://www.youtube.com/embed/slmWjDCdZRE', texto: 'Aprenda a melhor forma de respirar e se manter hidratado durante as sessões.' },
      { id: 6, titulo: 'Exercicios socos no aparelho', tipo: 'Bem-estar', videoUrl: 'https://www.youtube.com/embed/bU3ArMzuJIU', texto: 'Exercicio de socos no aparelho.' },
    ],
  },
  {
    id: 2,
