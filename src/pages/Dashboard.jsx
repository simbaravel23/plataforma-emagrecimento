...
const modulos = [
  {
    ...
    tipo: 'Alongamento', 
    videoUrl: 'https://youtu.be/17k8IZC_YNI', 
    texto: 'Rotina leve para preparar o corpo antes dos treinos mais intensos.' },
      { id: 3, titulo: 'Exercicios 1', tipo: 'Bem-estar', videoUrl: 'https://youtu.be/slmWjDCdZRE', texto: 'Aprenda a melhor forma de respirar e se manter hidratado durante as sessões.' },
      { id: 4, titulo: 'Exercicios 1 adaptado', tipo: 'Bem-estar', videoUrl: 'https://youtu.be/QhS_RKCh03g', texto: 'Aprenda a melhor forma de respirar e se manter hidratado durante as sessões.' },
      ...
      { id: 6, titulo: 'Exercicios socos no aparelho', tipo: 'Bem-estar', videoUrl: 'https://youtu.be/bU3ArMzuJIU', texto: 'Aprenda a melhor forma de respirar e se manter hidratado durante as sessões.' },
    ],
  },
  {
    id: 2,
    titulo: 'Módulo 2 • Movimento',
