...
const modulos = [
  {
    ...
    aulas: [
      { id: 1, titulo: 'Boas-vindas ao programa', tipo: 'Introdução', videoUrl: 'https://www.youtube.com/watch?v=l4BbL176NEA', texto: 'Conheça a estrutura do programa e como tirar o máximo proveito das aulas.' },
      { id: 2, 
    titulo: 'Alongamento inicial', 
    tipo: 'Alongamento', 
    videoUrl: 'https://www.youtube.com/watch?v=17k8IZC_YNI', 
    texto: 'Rotina leve para preparar o corpo antes dos treinos mais intensos.' },
      { id: 3, titulo: 'Exercicios 1', tipo: 'Bem-estar', videoUrl: 'https://www.youtube.com/watch?v=slmWjDCdZRE', texto: 'Exercicio de flexao de bracos sem apoio.' },
      { id: 4, titulo: 'Exercicios 1 adaptado', tipo: 'Bem-estar', videoUrl: 'https://www.youtube.com/watch?v=QhS_RKCh03g', texto: 'Exercicio de flexao de bracos com apoio.' },
      { id: 5, titulo: 'Exercicios socos', tipo: 'Bem-estar', videoUrl: 'https://www.youtube.com/watch?v=slmWjDCdZRE', texto: 'Aprenda a melhor forma de respirar e se manter hidratado durante as sessões.' },
      { id: 6, titulo: 'Exercicios socos no aparelho', tipo: 'Bem-estar', videoUrl: 'https://www.youtube.com/watch?v=bU3ArMzuJIU', texto: 'Exercicio de socos no aparelho.' },
    ],
  },
  {
    id: 2,
    ...
    aulas: [
      { id: 4, titulo: 'Treino para membros inferiores', tipo: 'Exercícios', videoUrl: 'https://www.youtube.com/embed/ysz5S6PUM-U', texto: 'Foco em pernas, glúteos e postura para fortalecer a base do corpo.' },
      { id: 5, titulo: 'Core e estabilidade', tipo: 'Exercícios', videoUrl: 'https://www.youtube.com/embed/ysz5S6PUM-U', texto: 'Sequência para abdômen e lombar com exercícios acessíveis.' },
    ],
  },
  {
    id: 3,
    titulo: 'Módulo 3 • Recuperação',
    descricao: 'Rotinas para recuperação ativa e relaxamento.',
    aulas: [
      { id: 6, titulo: 'Liberação miofascial', tipo: 'Recuperação', videoUrl: 'https://www.youtube.com/embed/ysz5S6PUM-U', texto: 'Técnicas para aliviar tensões e acelerar a recuperação muscular.' },
      { id: 7, titulo: 'Alongamento profundo', tipo: 'Alongamento', videoUrl: 'https://www.youtube.com/embed/ysz5S6PUM-U', texto: 'Sequência para ganhar elasticidade e reduzir dores após o treino.' },
    ],
  },
  {
    id: 4,
    titulo: 'Módulo 4 • Mentalidade',
    descricao: 'Meditações e hábitos para sustentar sua transformação.',
    aulas: [
      { id: 8, titulo: 'Meditação guiada', tipo: 'Mindset', videoUrl: 'https://www.youtube.com/embed/ysz5S6PUM-U', texto: 'Aprenda um exercício simples para acalmar a mente antes e depois do treino.' },
      { id: 9, titulo: 'Rotina diária saudável', tipo: 'Hábitos', videoUrl: 'https://www.youtube.com/embed/ysz5S6PUM-U', texto: 'Dicas práticas para criar consistência e manter resultados no longo prazo.' },
    ],
  },
];
